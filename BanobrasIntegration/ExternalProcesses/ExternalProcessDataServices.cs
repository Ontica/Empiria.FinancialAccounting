...
*                                                                                                            *
*  Summary  : Invokes Banobras' external processes through to stored procedures calls (Marimba).             *
*                                                                                                            *
...
namespace Empiria.FinancialAccounting.BanobrasIntegration {
  ...
  /// <summary>Invokes Banobras' external processes through to stored procedures calls (Marimba).</summary>
  static internal class ExternalProcessDataServices {

    static internal void ProcesarRentabilidad(ExternalProcessCommand command) {
