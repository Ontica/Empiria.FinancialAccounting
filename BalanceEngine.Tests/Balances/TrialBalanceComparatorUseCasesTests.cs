...
namespace Empiria.FinancialAccounting.Tests.BalanceEngine {
  ...
  public class TrialBalanceComparatorUseCasesTests {
    ...
    public void Should_Match_Dollarized_Balance_With_Trial_Balance() {
      ...
      var _trialBalance = trialBalance.Entries.Select(x => (TrialBalanceEntryDto) x);
      var _dollarizedBalance = dollarizedBalance.Entries.Select(x => (BalanzaDolarizadaEntryDto) x);
      var wrongEntries = 0;
    ...
    private int Should_Match_With_Dollar_Currency(IEnumerable<BalanzaDolarizadaEntryDto> dollarizedBalance,
    ...
    private int Should_Match_With_Euro_Currency(IEnumerable<BalanzaDolarizadaEntryDto> dollarizedBalance,
                                                IEnumerable<TrialBalanceEntryDto> trialBalance) {
      int wrongEntries = 0;
    ...
    private int Should_Match_With_Yen_Currency(IEnumerable<BalanzaDolarizadaEntryDto> dollarizedBalance,
                                               IEnumerable<TrialBalanceEntryDto> trialBalance) {
      int wrongEntries = 0;
