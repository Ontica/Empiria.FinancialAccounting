...
*  Assembly : FinancialAccounting.FinancialReports.Tests.dll   Pattern : Assembly Attributes File            *
*                                                              License : Please read LICENSE.txt file        *
*                                                                                                            *
*  Summary  : Tests suite for the financial reports of the financial accounting system.                      *
*                                                                                                            *
