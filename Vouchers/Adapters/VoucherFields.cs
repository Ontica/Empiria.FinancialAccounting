  ...
  public class VoucherFields {
    ...
    internal void EnsureValid() {
      if (AccountingDate.Date == new DateTime(2022, 1, 1)) {
        Assertion.Assert(VoucherTypeUID == "c94bfd2b-84a7-4807-99fc-d4cb23cd43e3",
      ...
      if (AccountingDate.Date != new DateTime(2022, 1, 1) && VoucherTypeUID == "c94bfd2b-84a7-4807-99fc-d4cb23cd43e3") {
        Assertion.AssertFail("Las pólizas de 'Carga de saldos iniciales' deben registrarse con fecha primero de enero de 2022.");
      }


      if (AccountingDate.Date == new DateTime(2022, 1, 2)) {
        Assertion.Assert(VoucherTypeUID == "e05e39ed-e744-43e1-b7b1-8e7b6c4e9895",
      ...
      if (AccountingDate.Date != new DateTime(2022, 1, 2) && VoucherTypeUID == "e05e39ed-e744-43e1-b7b1-8e7b6c4e9895") {
        Assertion.AssertFail("Las pólizas de 'Efectos iniciales de adopción de Norma' deben registrarse con fecha 2 de enero de 2022.");
      }
